      ...
      "architect": {
        "build": {
          ...
          "options": {
            ...
            "scripts": ["src/app/lib/runtime.js"],
          ...
          "configurations": {
            ...
            "alexander": {
              "fileReplacements": [
                {
                  "replace": "src/environments/environment.ts",
                  "with": "src/environments/environment.alexander.ts"
                }
              ]
            },
            "edgeware": {
              "fileReplacements": [
                {
                  "replace": "src/environments/environment.ts",
                  "with": "src/environments/environment.edgeware.ts"
                }
              ]
            },
            "robonomics": {
              "fileReplacements": [
                {
                  "replace": "src/environments/environment.ts",
                  "with": "src/environments/environment.robonomics.ts"
                }
              ]
            }
          }
